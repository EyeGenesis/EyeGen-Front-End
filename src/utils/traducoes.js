  ...
  pt: {
    ...
    home: {
      hero: {
        ...
        botao: "Já sou cliente"
      },
      ajuda: {
        titulo: "Como EYEGEN\nme ajuda?"
      },
      seguranca: {
        titulo: "Segurança aonde quer que você vá",
        card1: {
          titulo: "Nosso Compromisso com sua segurança",
          texto: "Com tecnologia e empatia o EyeGen trabalha para que você possa se locomover sem preocupar com obstáculos",
          link1: "Funcionalidades do Produto",
          link2: "Como o EYEGEN me mantém em segurança",
          link3: "Ver mais relatos"
        },
        card2: {
          titulo: "Nos preocupamos com quem é importante para você",
          texto: "O Eyegen é para todos. Desenvolvido para acompanhar cada fase da vida com conforto e tecnologia."
        }
      },
      infoMascote: {
        cards: {
          sobre: {
            titulo: "Sobre nós",
            texto: "Descubra quem somos, o que nos motiva e o que visamos para o futuro",
            link: "Saber mais"
          },
          planos: {
            titulo: "Planos",
            texto: "Descubra o plano ideal para suas necessidades. Escolha o que melhor se adapta a você.",
            link: "Saber mais"
          },
          suporte: {
            titulo: "Suporte",
            texto: "Precisa de ajuda? Conte com a nossa equipe especializada para te dar o suporte que você precisa.",
            link: "Saber mais"
          }
        },
        mascote: {
          titulo: "Conheça a GENY, nossa mascote cão guia!",
          p1: "Criada para facilitar sua interação com nossa plataforma, a Geny te guia de forma simples e inteligente por cada etapa, desde conhecer os recursos do EyeGen até realizar sua compra com segurança e praticidade.",
          p2: "Ela cria registros, oferece informações, compartilha dicas de uso e cuidados, e garante que sua jornada seja leve, acessível e acolhedora.",
          botao: "Conversar com a GENY"
        }
      },
      produto: {
        titulo: "Sobre Nosso Produto",
        subtitulo: "Tranforme seu dia a dia com autonomia e segurança",
        botao: "Comprar Agora",
        cards: {
          design: {
            titulo: "Design Confortável",
            texto: "Texto descritivo sobre o design.",
            link: "Saber mais"
          },
          camera: {
            titulo: "Câmera de 1080p",
            texto: "Texto",
            link: "Saber mais"
          },
          bateria: {
            titulo: "Bateria de Qualidade",
            texto: "Bateria com duração de 5 a 8 horas",
            link: "Saber mais"
          },
          material: {
      ...
      quemUsa: {
        titulo: "Quem usa o EYEGLASS?",
        subtitulo: "Pessoas com Baixa Visão e Deficientes Visuais",
        p1: "Nossos óculos assistivos trazem mais nitidez e clareza para pessoas com baixa visão. A tecnologia amplia textos, aumenta o contraste e destaca obstáculos, devolvendo a confiança e a independência para o seu dia a dia.",
        p2: "Além disso contamos com reconhecimentos de objetos com retorno por voz para pessoas cegas"
      },
      comunidade: {
        titulo: "Nossa Comunidade",
        texto: "Experimente o Eyegen e compartilhe da mesma emoção",
        botao: "Desejo Fazer Parte",
        carrosselTitulo: "Experiências reais com o Eyegen",
        depoimentos: [
          {
    ...
    sobreNos: {
      hero: {
        titulo: "Sobre Nós",
        texto: "Acreditamos na tecnologia como uma ponte direta para a independência de pessoas com deficiência visual. Com essa convicção, o EyeGen nasceu em ambiente acadêmico com objetivo de construir uma ferramenta que auxiliasse pessoas a se locomoverem com mais segurança e confiança."
      },
      visao: {
        titulo: "Um Olhar Sem Fronteiras",
        texto: "A visão do EyeGen é tornar-se a principal referência global em tecnologia assistiva para pessoas com baixa ou nenhuma visão, evoluindo continuamente por meio de inovação e pesquisa, a fim de oferecer soluções práticas e intuitivas que promovam autonomia e melhoram a qualidade de vida."
      },
      bussola: {
        titulo: "Nossa Bússola",
        cards: [
          {
            titulo: "Criatividade",
            texto: "Enxergamos possibilidades além do óbvio, explorando novas ideias e abordagens para criar soluções tecnológicas verdadeiramente transformadoras."
          },
          {
            titulo: "Impacto Social",
            texto: "Criamos oportunidades para que todos ocupem seu espaço na sociedade, elevando a autoestima e impactando positivamente a vida de pessoas em situação de vulnerabilidade."
          },
          {
            titulo: "Inclusão",
            texto: "Nosso foco é incluir pessoas com deficiência visual, independentemente de sua etnia. Por meio do nosso produto, buscamos ampliar seu espaço, sua voz e suas oportunidades na sociedade."
          },
          {
            titulo: "Respeito",
            texto: "Respeitamos cada indivíduo em sua essência, criando tecnologias que honram sua dignidade, fortalecem sua autonomia e atendem às suas necessidades com cuidado."
          },
          {
            titulo: "Colaboração",
            texto: "Acreditamos que grandes avanços nascem do trabalho em conjunto, unindo diferentes perspectivas para desenvolver uma experiência segura, humana e eficaz para nossos usuários."
          }
        ]
      },
      missao: {
        titulo: "O que nos move",
        texto: "Nossa missão é promover a autonomia e elevar significativamente a sua qualidade de vida. Acreditamos que todos merecem as ferramentas e o suporte para viver uma vida plena e independente."
      },
      quemSomos: {
